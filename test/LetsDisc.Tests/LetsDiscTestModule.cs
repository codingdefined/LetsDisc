...
using LetsDisc.Tests.DependencyInjection;

namespace LetsDisc.Tests
{
    [DependsOn(
        typeof(LetsDiscApplicationModule),
        typeof(LetsDiscEntityFrameworkModule),
        typeof(AbpTestBaseModule)
        )]
    public class LetsDiscTestModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            RegisterFakeService<AbpZeroDbMigrator<LetsDiscDbContext>>();
